      ...
      <div class="page-wrapper compact-wrapper" id="pageWrapper">
        ...
        <div class="page-main-header">
          <div class="main-header-right row m-0">
            <div class="main-header-left">
              <div class="logo-wrapper"><a href="index.html"><img class="img-fluid" src="{asseturl}luq/assets/images/logo/logo.png" alt=""></a></div>
              <div class="dark-logo-wrapper"><a href="index.html"><img class="img-fluid" src="{asseturl}luq/assets/images/logo/dark-logo.png" alt=""></a></div>
            ...
            <div class="nav-right col pull-right right-menu p-0">
              <ul class="nav-menus">
                ...
                <li class="onhover-dropdown p-0">
                  <button class="btn btn-primary-light" type="button"><a href="{logoutURL}"><i data-feather="log-out"></i>Log out</a></button>
                </li>
              </ul>
            </div>
        ...
        <div class="page-body-wrapper sidebar-icon">
          ...
          <header class="main-nav">
            <div class="sidebar-user text-center"><a class="setting-primary" href="javascript:void(0)"><i data-feather="settings"></i></a><img class="img-90 rounded-circle" src="{gravatar_url}" alt="">
              <div class="badge-bottom">
                <!-- <span class="badge badge-primary">New</span> -->
              </div><a href="user-profile.html">
                <h6 class="mt-3 f-14 f-w-600">{current_user.data.display_name}</h6></a>
              <p class="mb-0 font-roboto">{current_user.roles[0]}</p>
              ...
              <div class="main-navbar">
                ...
                <div id="mainnav">           
                  <ul class="nav-menu custom-scrollbar">
                    ...
                    <li class="dropdown"><a class="nav-link menu-title link-nav" class:active={$location === '/' || $location === '/dashboard'} href="#/dashboard"><i data-feather="git-pull-request"></i><span>Dashboard </span></a></li>
                    
                    <li class="dropdown"><a class="nav-link menu-title" class:active={$location === '/page1' || $location === '/page2' || $location === '/'} href="javascript:void(0)"><i data-feather="home"></i><span>Dashboard</span></a>
                      <ul class="nav-submenu menu-content">
                        <li><a href="#/page1" class:active={$location === '/page1'} >Default</a></li>
                        <li><a href="#/page2" class:active={$location === '/page2'} >Ecommerce</a></li>
                      </ul>
                    </li>
              ...
              <div class="container-fluid">
                  <div class="row">
                      <div class="col-md-6 footer-copyright">
                          <p class="mb-0">Copyright 2021-22 © 4in44 All rights reserved.</p>
                      </div>
                      <div class="col-md-6">

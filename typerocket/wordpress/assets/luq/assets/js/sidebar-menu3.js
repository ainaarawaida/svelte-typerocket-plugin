...
if($('#pageWrapper').hasClass('compact-wrapper')){
      ...
      jQuery('.menu-title').click(function () {
          jQuery('.menu-title').removeClass('xactivex');
...
// page xactivex
$( ".main-navbar" ).find( "a" ).removeClass("xactivex");
$( ".main-navbar" ).find( "li" ).removeClass("xactivex");
...
$(".main-navbar ul>li a").filter(function() {
    ...
    if(link){
        if (current.indexOf(link) != -1) {
            $(this).parents().children('a').addClass('xactivex');
            $(this).parents().parents().children('ul').css('display', 'block');
            $(this).addClass('xactivex');
...
$('.custom-scrollbar').animate({
    scrollTop: $('a.nav-link.menu-title.xactivex')?.offset()?.top - 500
}, 1000);